...
| תכונה | תיאור |
| --- | --- |
| 🥂 סשן דייט | סשן שלם לדייט: שאלות (שני בני הזוג עונים) + אתגרים מרגשים, וציון התאמה בסוף עם מעקב שיפור לאורך זמן |
| 🤖 ניתוח עם ChatGPT | בסוף הסשן נפתח ChatGPT עם פרומפט מוכן + התשובות; הוא מחזיר ציון התאמה שמזינים חזרה לאפליקציה (ללא סוכן AI מובנה) |
